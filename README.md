...
## Versions
### 17 May 2026
Process Management with CloseProcess. Before you wasn't able to close the terminal once opened.
### 16 May 2026
Still not downloadable. It was internally called Ice Cream. In the same day, i founded Koala (rolling release) and the Koala Terminal Emulator.
### 15 May 2026
Not downloadable. It was internally called Nightly Alpine. That name explains why the wallpaper is an alpine. In this day, i added support for tiny screens (64pt font).
